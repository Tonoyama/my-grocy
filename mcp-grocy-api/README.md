...
## Natural Language Item Registration (OpenAI)

You can register items via natural language using the MCP server and OpenAI API:

```bash
export OPENAI_API_KEY=your_openai_key
export MCP_HTTP_URL=http://localhost:8080/mcp
node scripts/nl-register.mjs "Milk 2 bottles 2024-12-31 198"
```

Flags:
- `--dry-run`: Prints the resolved action without writing to Grocy.
